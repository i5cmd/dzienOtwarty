...
$FULLSCREEN_IMAGE.on("touchend", (e: any) => galleryManagement.grabPhoto(true, e, $FULLSCREEN_IMAGE));
$FULLSCREEN_IMAGE.on("pointerup", (e: any) => galleryManagement.grabPhoto(false, e, $FULLSCREEN_IMAGE));
$FULLSCREEN_IMAGE.on("touchstart", (e: any) => galleryManagement.grabPhoto(false, e, $FULLSCREEN_IMAGE));
